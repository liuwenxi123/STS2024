...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, default="data_test_teeth", help="train data path")  # 测试集路径
    parser.add_argument("--metrics", nargs='+', default=['iou', 'dice'], help="metrics")
    parser.add_argument("--model_type", type=str, default="vit_b", help="sam model_type")
    parser.add_argument("--sam_checkpoint", type=str, default="workdir/models/sam-med2d/epoch12_sam.pth", help="sam checkpoint")    # 模型路径
